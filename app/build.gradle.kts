...
dependencies {
    ...
    androidTestImplementation("androidx.test.ext:junit:1.1.5") // Use a versão mais recente
    androidTestImplementation("androidx.test.espresso:espresso-core:3.5.1") // Use a versão mais recente
    androidTestImplementation("androidx.test:runner:1.5.2") // Use a versão mais recente
    androidTestImplementation("androidx.test:rules:1.5.0") // Use a versão mais recente
}
