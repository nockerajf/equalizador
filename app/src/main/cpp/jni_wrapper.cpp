...
JNI_FN(com_example_equalizador, NativeThreeBand, nativeCreate)
...
JNI_FN(com_example_equalizador, NativeThreeBand, nativeInit)
(JNIEnv*, jobject,
...
JNIEXPORT void JNICALL
JNI_FN(com_example_equalizador, NativeThreeBand, nativeProcess)
(JNIEnv *env, jobject,
...
// ------- libera memória
JNIEXPORT void JNICALL
JNI_FN(com_example_equalizador, NativeThreeBand, nativeDestroy)
